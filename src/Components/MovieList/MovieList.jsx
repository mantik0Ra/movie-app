            ...
            <section className={cl.movieList}>
                ...
                <div ref={container} className={cl.movieContainers}>
                    {resp.map(item => 
                        ...
                        <button onClick={moveList} className={cl.btnRigth}><i className='fa-solid fa-arrow-right'></i></button>
                        <button onClick={moveList} className={cl.btnLeft}><i className='fa-solid fa-arrow-left'></i></button>
